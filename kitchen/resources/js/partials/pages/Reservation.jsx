...
export default function Reservation() {
  ...
  const getReservations = () => {
    axios.get(`/api/getReservations/${auth.id}`,{
      headers: {
      ...
      <div className="container">
        ...
        <ul className="responsive-table">
          ...
          <li className="table-row">
            ...
            <div className="center"><p className='center'>there are no reservations</p></div>
          ...
          <>{reservations.map(reservation => (
            <li key={reservation.id} className="table-row">
              ...
              <div className="col col-5" data-label="state">{reservation.state == 0 ? "pending" : reservation == 1  ? "yes" : "no"}</div>
